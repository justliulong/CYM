...
try:
    ...
    # 抛出异常，mamba不可用，使用替代模块（该模块训练速度相对非常慢）
    print("mamba_ssm not found, try from selective_scan import selective_scan_fn ...")
    try:
        from selective_scan import selective_scan_fn
        from selective_scan import selective_scan_ref
    except:
        raise Exception("selective_scan not found, selective_scan_fn not available")
